...
void glfwDraw (GLFWwindow *window)
{
   ...
   SetModelStat();
	...
	PlaceAnimatedModel(damesh, 0, -3, -15, 1, 1, 1, spin, frm%24);
...
int main( int argc, char *argv[] )
{
   ...
   srand(time(0));
	...
	SetMaterial(1);
	damesh = LoadMesh("../Assets/Models/charWaving.dae"); /*damesh = LoadMesh("../Assets/Models/gem.dae"); *//*damesh = LoadMesh("../Assets/Models/dancingCylinderTriangulated.dae");*///damesh = LoadMesh("../Assets/Models/simpleDancingCylinder.dae");
