...
glm::mat4 SetModel(float x, float y, float z, float Sx, float Sy, float Sz, glm::mat4 in) {
	glm::mat4 Trans = glm::translate( glm::mat4(1.0f), glm::vec3(x, y, z));
   glm::mat4 Scale = glm::scale(glm::mat4(1.0f), glm::vec3(Sx, Sy, Sz));
   //glm::mat4 Rotate = glm::rotate(glm::mat4(1.0f), 90.0f, glm::vec3(0.0f, 1.0f, 0.0f));
   glm::mat4 ctm = Trans * in * Scale;
	safe_glUniformMatrix4fv(h_uModelMatrix, glm::value_ptr(ctm));
