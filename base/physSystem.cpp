...
void physGrapple(float lx,float ly,float lz){
   ...
   btCollisionWorld::ClosestRayResultCallback RayCallback(btVector3(lookAtPoint.x-dir.x,lookAtPoint.y+dir.y,lookAtPoint.z-dir.z), btVector3(lookAtPoint.x-2*dir.x,lookAtPoint.y+2*dir.y,lookAtPoint.z-2*dir.z));
   dynamicsWorld->rayTest(btVector3(lookAtPoint.x-dir.x,lookAtPoint.y+dir.y,lookAtPoint.z-dir.z), btVector3(lookAtPoint.x-2*dir.x,lookAtPoint.y+2*dir.y,lookAtPoint.z-2*dir.z), RayCallback);
