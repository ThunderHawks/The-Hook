...
uniform mat4 uLightFarProjMatrix;
...
void main() {
   ...
   vShadowPos = VMNDCtoTex * uLightProjMatrix * uLightViewMatrix * transPos;
   vShadowPosFar = VMNDCtoTex * uLightFarProjMatrix * uLightViewMatrix * transPos;
