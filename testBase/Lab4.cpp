...
//
		...
		PlaceAnimatedModel(playerMesh, 0, -3, -15, 1, 1, 1, 0, frm%24);
//
...
int main( int argc, char *argv[] )
{
   ...
   //File name to load
   string fileName;
   //whether name inputted is valid
   ...
   while(validFile == false) {
      ...
      //If 'd' was entered, then default level
   ...
   playerMesh = LoadMesh("../Assets/Models/dancingCylinder.dae");
